...
function (x, y, ...) 
{
	...
	if (det(CovarianceDuBruitDeLa[[cle]]) == 0) {
        ...
        MoyenneDeLa[[cle]] = apply(matrix(X_[which(Y_ == (cle-1)), ], ncol = dim(X_)[2], 
            nrow=length(which(Y_ == (cle-1)))),MARGIN = 2, FUN = mean)
